<template>
  <div class="bg-css rounded-[12px] relative mt-[24px]">
    ...
    <div class="flex justify-between">
      ...
      <a-button :id="metatrustInfo.title" v-if="metatrustInfo.isMetatrust" type="link" class="view-detail-btn" style="font-size: 16px;" @click="goMetaScan">View More</a-button>
    </div>
