<template>
  <div
    ...
    <div class="flex justify-between mb-[32px]">
      ...
      <a-button class="w-[131px] h-[43px]">Ops</a-button>
    </div>
    <div class="flex">
      ...
      <div class="ml-[64px] w-3/5">
        ...
        <div class="flex w-full">
          ...
          <div class="w-1/2">
            ...
            <div class="text-[#73706E] dark:text-[#E0DBD2] mt-[8px]">{{ fromNowexecutionTime(workflowsDetailsData.startTime, "noThing") }} by {{ workflowsDetailsData.triggerUser}}</div>
