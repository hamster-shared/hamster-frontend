<template>
<div :class="theme.themeValue === 'dark' ? 'dark-css' : 'white-css'" class="bg-[#FFFFFF] dark:bg-[#1D1C1A] rounded-[12px] p-[32px] mt-4">
  <div class="text-[30px] font-bold">ALine Service</div>
  <div class="my-[20px] text-[#73706E] dark:text-[#E0DBD2] font-light">Hamster automates your Web3.0 project workflows seamlessly. Check, build, and deploy your code directly through code repository. Ready to start Aline Service? Get started with use an existing repository.</div>
  <a-button type="primary" @click="goCreateProject">Add New Project</a-button>
  <div class="text-[24px] font-bold mt-[50px] mb-[32px]">Haven't built the project yet?<br/>Get started with one of our Templates !</div>
  <div class="flex">
    <div class="card-bg">
      <img class="img" src="@/assets/images/ContractTemplates.png" />
      <div class="title">Contract Templates</div>
      <div class="desc" id="desc-h">Explore a world of possibilities with our support for all the leading ecosystems - EVM, Aptos, StarkWare, Sui, Internet Computer, and more.</div>
